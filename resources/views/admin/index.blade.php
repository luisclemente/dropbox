{{--Codigo para extender de la vista maestra--}}
...
@section('scripts')
    {{--//Al poner estos scripts aqui solo se ejecutan cuando los necesitemos, asi optimizamos la app.--}}


        {{--//script para mostrar los graficos--}}
